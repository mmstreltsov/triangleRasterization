...
import ru.hse.project.RasterTest.Animation;
import ru.hse.project.RasterTest.State.Math.Coord2D;
import ru.hse.project.RasterTest.State.Math.HomogeneousCoord;
...
public class Scene implements Transformation {
    ...
    /**
     * Анимация разбита на 2 шага. Второй шаг - применение преобразования камеры и Проекции на канвас.
     * @return матрица преобразования
     */
